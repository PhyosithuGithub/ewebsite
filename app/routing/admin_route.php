<?php
#Admin Panel
$router->map("GET","/admin","App\Controllers\AdminController@index","Admin Panel");
...
$router->map("POST","/admin/subcategory/create","App\Controllers\SubCategoryController@store","SubCategory Store");
